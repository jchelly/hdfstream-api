...
// Check that we can't generate a tar file of a directory we don't have access to
public class TestTarFileNoAccess {
    ...
    public void main() throws VirtualDirectoryException, IOException {
        ...
        String config =
            "root,                          no_such_file,                   0, 0, directory, , role2\n" +
        ...
        // Now we read back the (hopefully empty) tar file and check the results
